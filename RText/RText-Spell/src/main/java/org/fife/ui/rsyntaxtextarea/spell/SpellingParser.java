...
//		System.out.println("Loading dictionary took " + secs + " seconds");
    ...
    public boolean spellCheckToken( Token token )
    {
...
//		long startTime = System.currentTimeMillis();
        ...
        else
        {
            ...
            for( int line = 0; line < lineCount; line++ )
            {
                ...
                {
                    //System.out.println( "Token type: " + t.getTokenType() );
                    if( spellCheckToken( t ) )
                    {
                        startOffs = t.offset;
    ...
    private static class SpellingParserNotice extends DefaultParserNotice
    {
        ...
        public String getToolTipText()
        {
            ...
            if( sp.getAllowIgnore() )
            {
                ...
                text = MessageFormat.format( text, new String[]
                        {
                            word
                        } );
